...
export const FloatingActions = ({
  ...
  return (
    <div className="fixed right-8 bottom-8 z-9999 flex flex-col gap-2">
      <Button
        ...
        onClick={backtoTop}
        className={clsx(
          "animate-in fade-in zoom-in border-none shadow-md shadow-black/40 duration-200",
          !isBackToTopVisible && "pointer-events-none! -z-50! opacity-0!",
        )}
      >
        <ArrowUp />
